                        ...
                        <div class="login-form">
                            <form action="" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="au-input au-input--full" type="text" name="user_name" placeholder="Username">
                                </div>
                                ...
                                <div class="form-group">
                                    <label>Age</label>
                                    <input class="au-input au-input--full" type="number" name="age" placeholder="Age">
                                </div>
